	...
	internal class Program
	{
		...
		static async Task AddDishData(DBContext context)
		{
			List<Dish> dishes = new List<Dish>
			{
			 ...
			 new Dish { DishName = "Margherita Pizza", Price = 12.00m, CategoryId = 6, Description = "Pizza topped with tomato sauce, mozzarella cheese, and fresh basil." },
			 new Dish { DishName = "Pepperoni Pizza", Price = 14.00m, CategoryId = 6, Description = "Pizza topped with tomato sauce, mozzarella, and spicy pepperoni sausage." },
			 new Dish { DishName = "Vegetarian Pizza", Price = 13.00m, CategoryId = 6, Description = "Pizza topped with fresh vegetables such as bell peppers, mushrooms, and olives, without meat." },
			 ...
			 new Dish { DishName = "Margarita", Price = 10.00m, CategoryId = 4, Description = "A cocktail made with tequila, lime juice, and triple sec, usually served with a salted rim." },
			 new Dish { DishName = "Mojito", Price = 9.00m, CategoryId = 4, Description = "A refreshing cocktail made with rum, lime juice, sugar, and mint." },
			 new Dish { DishName = "Pina Colada", Price = 11.00m, CategoryId = 4, Description = "A tropical cocktail made with rum, pineapple juice, and coconut cream." },
			 new Dish { DishName = "Wine", Price = 8.00m, CategoryId = 4, Description = "Choice of red, white, or rosé wine, to complement your meal." },
			 new Dish { DishName = "Coffee", Price = 3.00m, CategoryId = 4, Description = "Espresso, cappuccino, or latte, a popular beverage to enjoy with any meal." },
			...
			for (int i = 1; i <= 4; i++)
			{
				...
				for (int j = 1; j <= 10; j++)
				{
					for (int k = 1; k <= 3; k++)
					{
						...
						{
							ScheDate = DateOnly.FromDateTime(new DateTime(2024, 11, j)),
							EmpId = empId,
							ShiftId = k
						};
						schedules.Add(schedule);

						(int, int) time = k switch
						{
							1 => (8, 12),
							2 => (13, 17),
							3 => (18, 22),
						...
						{
							ScheId = schedules.Count,
							Status = AttendanceStatus.ClockOut,
							CheckIn = new DateTime(2024, 11, j, time.Item1, 0, 0),
							CheckOut = new DateTime(2024, 11, j, time.Item2, 0, 0),
							WorkingHours = new decimal(time.Item2 - time.Item1)
						};
