...
namespace WebApp.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public async Task<IActionResult> AddOrderItem(OrderItemViewModel orderItem, int dishId)
        {
            ...
            var itemStatus = order.Status == OrderStatus.Reservation ? OrderItemStatus.Reservation : OrderItemStatus.Pending;
        ...
        [HttpGet("CustomerArrived")]
        public async Task<IActionResult> CustomerArrived(long orderId, int tableId)
        {
            var order = await _orderRepository.GetByIDAsync(orderId);
            if (order == null)
            {
            ...
            {
                var reservation = await _reservationRepository.GetByIDAsync(order.ResId.Value);
                if (reservation != null)
                {
